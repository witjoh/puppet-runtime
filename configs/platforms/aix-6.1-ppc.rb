platform "aix-6.1-ppc" do |plat|
  ...
  packages = [
    ...
    "https://artifactory.delivery.puppetlabs.net/artifactory/rpm__remote_aix_linux_toolbox/ppc/bzip2/bzip2-1.0.6-2.aix6.1.ppc.rpm",
    "https://artifactory.delivery.puppetlabs.net/artifactory/rpm__remote_aix_linux_toolbox/ppc-6.1/gcc/libstdcplusplus-6.3.0-1.aix6.1.ppc.rpm",
    "https://artifactory.delivery.puppetlabs.net/artifactory/rpm__remote_aix_linux_toolbox/ppc/gmp/gmp-6.1.2-1.aix6.1.ppc.rpm",
    "https://artifactory.delivery.puppetlabs.net/artifactory/rpm__remote_aix_linux_toolbox/ppc/mpfr/mpfr-3.1.2-3.aix6.1.ppc.rpm",
    "https://artifactory.delivery.puppetlabs.net/artifactory/rpm__remote_aix_linux_toolbox/ppc/libmpc/libmpc-1.0.3-1.aix6.1.ppc.rpm",
