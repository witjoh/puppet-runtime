platform "aix-7.1-ppc" do |plat|
  ...
  # We can't rely on yum, and rpm can't download over https on AIX, so we curl the packages before installing them
  ...
  packages = {
    ...
    "libstdcplusplus-6.3.0-1.aix7.1.ppc.rpm" => "https://artifactory.delivery.puppetlabs.net/artifactory/rpm__remote_aix_linux_toolbox/ppc-7.1/gcc/libstdcplusplus-6.3.0-1.aix7.1.ppc.rpm", # for gmp; change version?
    # gcc dependencies:
    ...
    "libgcc-6.3.0-1.aix7.1.ppc.rpm"       => "https://artifactory.delivery.puppetlabs.net/artifactory/rpm__remote_aix_linux_toolbox/ppc-7.1/gcc/libgcc-6.3.0-1.aix7.1.ppc.rpm", # requires info
    "gcc-6.3.0-1.aix7.1.ppc.rpm"          => "https://artifactory.delivery.puppetlabs.net/artifactory/rpm__remote_aix_linux_toolbox/ppc-7.1/gcc/gcc-6.3.0-1.aix7.1.ppc.rpm",
    "libstdcplusplus-devel-6.3.0-1.aix7.1.ppc.rpm" => "https://artifactory.delivery.puppetlabs.net/artifactory/rpm__remote_aix_linux_toolbox/ppc-7.1/gcc/libstdcplusplus-devel-6.3.0-1.aix7.1.ppc.rpm",
    "gcc-cpp-6.3.0-1.aix7.1.ppc.rpm"      => "https://artifactory.delivery.puppetlabs.net/artifactory/rpm__remote_aix_linux_toolbox/ppc-7.1/gcc/gcc-cpp-6.3.0-1.aix7.1.ppc.rpm", # requires libstdc++
    "gcc-cplusplus-6.3.0-1.aix7.1.ppc.rpm" => "https://artifactory.delivery.puppetlabs.net/artifactory/rpm__remote_aix_linux_toolbox/ppc-7.1/gcc/gcc-cplusplus-6.3.0-1.aix7.1.ppc.rpm", # I guess we need both gcc-cpp and gcc-cplusplus
  }
